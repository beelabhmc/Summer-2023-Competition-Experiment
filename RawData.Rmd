...
let d_ij = distance between nest i and j. Note ij is not the same as ji
...
```{r}
#pretend I have already made the distances (probabilities of traversing) and they are stored in junction_dist
#junc_data <-
#junction_dist <- matrix(junc_data, 8, 8, byrow, dimnames)
...
#because this is a distance matrix (of actually 1/distance), we can use vector multiplication
