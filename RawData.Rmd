...
junction_dist= matrix(
  ...
  c(-0*log(0.5, base = 2), -7*log(0.5, base = 2), -7*log(0.5, base = 2), -7*log(0.5, base = 2), -9*log(0.5, base = 2), -9*log(0.5, base = 2), -9*log(0.5, base = 2), -9*log(0.5, base = 2), 
    -7*log(0.5, base = 2), -0*log(0.5, base = 2), -3*log(0.5, base = 2), -3*log(0.5, base = 2), -9*log(0.5, base = 2), -9*log(0.5, base = 2), -9*log(0.5, base = 2), -9*log(0.5, base = 2), 
    -7*log(0.5, base = 2), -3*log(0.5, base = 2), -0*log(0.5, base = 2), -1*log(0.5, base = 2), -9*log(0.5, base = 2), -9*log(0.5, base = 2), -9*log(0.5, base = 2), -9*log(0.5, base = 2), 
    -7*log(0.5, base = 2), -3*log(0.5, base = 2), -1*log(0.5, base = 2), -0*log(0.5, base = 2), -9*log(0.5, base = 2), -9*log(0.5, base = 2), -9*log(0.5, base = 2), -9*log(0.5, base = 2), 
    -9*log(0.5, base = 2), -9*log(0.5, base = 2), -9*log(0.5, base = 2), -9*log(0.5, base = 2), -0*log(0.5, base = 2), -7*log(0.5, base = 2), -7*log(0.5, base = 2), -7*log(0.5, base = 2), 
    -9*log(0.5, base = 2), -9*log(0.5, base = 2), -9*log(0.5, base = 2), -9*log(0.5, base = 2), -7*log(0.5, base = 2), -0*log(0.5, base = 2), -3*log(0.5, base = 2), -3*log(0.5, base = 2), 
    -9*log(0.5, base = 2), -9*log(0.5, base = 2), -9*log(0.5, base = 2), -9*log(0.5, base = 2), -7*log(0.5, base = 2), -3*log(0.5, base = 2), -0*log(0.5, base = 2), -1*log(0.5, base = 2), 
    -9*log(0.5, base = 2), -9*log(0.5, base = 2), -9*log(0.5, base = 2), -9*log(0.5, base = 2), -7*log(0.5, base = 2), -3*log(0.5, base = 2), -1*log(0.5, base = 2), -0*log(0.5, base = 2)), 
...
#should I make every element 1/itself?
...
for(i in 1:8) {
  for (j in 1:8) {
    if(j!=i){
    pi <- props398 %>% filter(nest == nests[i])  %>% select(ants_nest_prop)
    pj <- props398 %>% filter(nest == nests[j])  %>% select(ants_nest_prop)
    dij = junction_dist[i,j]
    prob_moving_sum = prob_moving_sum + ((pi*pj)/dij)
    }
  }
}
prob_moving_sum
...
weighted_efficiency = (1/(n*(n-1))) * prob_moving_sum
